...
function ParticipantsPage() {
  ...
  return (
    <div className="p-6">
      <header className="flex justify-between items-center mb-6 pb-4 border-b border-primary">
        <h2 className="text-2xl font-bold text-primary">Управление участниками</h2>
      ...
      >
        ...
        <p className="mt-2 text-sm text-muted">Это действие также удалит его из всех походов.</p>
      </ConfirmModal>
    </div>
  );
}
